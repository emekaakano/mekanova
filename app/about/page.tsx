...
export const metadata = {
  ...
  description:
    'Mekano is a Digital Transformation practitioner helping businesses put AI to real, practical work.',
};
  ...
  return (
    <div className="bg-slate-50 px-6 py-16">
      <div className="mx-auto max-w-3xl">
        <h1 className="mb-8 text-4xl font-bold text-slate-900">About Mekano</h1>

        {/* Bio */}
        <div className="mb-12 space-y-5 text-lg leading-relaxed text-slate-600">
          <p>
            I&apos;m Mekano — a Digital Transformation practitioner who got tired of watching
            organizations get sold AI hype without the practical roadmap to act on it.
          </p>
          <p>
